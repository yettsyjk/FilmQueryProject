...
public class Film {
	...
	//constructor for findFilmById
	public Film( int id, String title, String description, int release_year, int language_id, int rental_duration, double rental_rate, int length,
			double replacement_cost, String rating, String special_features,
	...
	public Film(String title, String description, String rating, String special_features, int id, int release_year,
			int language_id, int rental_duration, int length, int actor_id, double rental_rate, double replacement_cost,
			List<Actor> actorsInFilm, Language language ) {
		super();
		this.title = title;//
		this.description = description;//
	...
	public Film(int id, String title, String description, int release_year, String rating, List<Actor> actorsInFilm, Language language ) {
...
//////////////Getter and Setters///////////////
	...
	public String toString() {
		return "Film [title = " + title + ", description = " + description + ", special Features = " + specialFeatures
				+ ", rating = " + rating + ", id =" + id + ", release Year=" + releaseYear + ", languageId = " + languageId
				+ ", rental_duration =" + rental_duration + ", length = " + length + ", rentalRate = " + rentalRate
				+ ", replacementCost =" + replacementCost + ", actorsInFilm = " + actorsInFilm + ", language = " + language
				+ "]";
	}
